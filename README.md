...
2) To send message you need to have gmail and application password(you can create it in your google account). This application didn't work with different mail.
